...
export const metadata: Metadata = {
  title:
    "Stock Trading Scam Recovery - Folco Capital",
  description:
    "Expert stock trading scam recovery services. Folco Capital helps victims dispute fraudulent credit/debit card transactions to reclaim lost funds.",
};
